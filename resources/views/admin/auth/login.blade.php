...
<head>
    ...
    <title>Waktu Solat API — Admin Login</title>
    @vite(['resources/css/app.css'])
</head>
<body class="h-full">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="text-center text-2xl font-bold text-gray-900">Waktu Solat Admin</h2>
            <p class="mt-2 text-center text-sm text-gray-600">Sign in to manage prayer times</p>
        </div>
